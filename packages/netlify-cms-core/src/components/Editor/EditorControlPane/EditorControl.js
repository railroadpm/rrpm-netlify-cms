...
import { colors, colorsRaw, transitions, lengths, borders } from '@rrpm/netlify-cms-ui-default';
...
class EditorControl extends React.Component {
  ...
  render() {
    ...
    return (
      <ControlContainer className="nc-app-editor-control-container" data-field="{fieldName}">
        {sectionName && (
